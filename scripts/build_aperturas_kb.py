...
def build_knowledge_base(source_path: Path, sheet_name: str) -> dict[str, Any]:
        ...
        records.append(
            {
                ...
                "openingTime": kept_event["time"],
                "openingDateTime": kept_event["activationDateTime"],
            ...
            discarded_events.append(
                {
                    ...
                    "keptOpeningTime": kept_event["time"],
                    "keptOpeningDateTime": kept_event["activationDateTime"],
                    "secondsFromKeptOpening": int(
    ...
    records.sort(key=lambda item: (item["date"], item["openingTime"], item["storeLabel"]))
...
def build_argument_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Build a clean knowledge base of store openings from a source workbook."
    )
        ...
        json.dumps(
            {
                ...
                "cleanOpenings": payload["meta"]["cleanOpenings"],
